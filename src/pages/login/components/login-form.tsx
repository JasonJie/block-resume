...
const LoginForm: React.FC<LoginFormProps> = ({ changeLoginType }) => {
    const [form] = Form.useForm();

    const handleChangeLoginType = useCallback(() => {
        changeLoginType(LOGIN_TYPE.REGISTER);
    }, [changeLoginType]);
    return (
        <>
            <div className="text-3xl font-normal text-center mb-6">登录</div>
            <Form form={form}>
                <Form.Item
                    name="username"
...
const LoginFormPage = React.memo(LoginForm);
